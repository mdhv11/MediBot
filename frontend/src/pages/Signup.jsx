...
const Signup = () => {
  ...
  const submitHandler = async (event) => {
    ...
    try {
      ...
      formDataWithFile.append('bloodType', formData.bloodType);
      if (selectedFile) {
      ...
      setError(error.message || 'Something went wrong'); // Handle errors appropriately
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2'>
        ...
        <div className='hidden lg:block bg-blue-500 rounded-l-lg'>
          ...
          <div className="mb-5 flex items-center justify-between">
              ...
              <div className='mt-7'>
            <button type='submit' className='w-full bg-blue-500 text-white leading-[30px] rounded-lg px-4 py-3' disabled={isLoading}>
